...
3. Increments mem[0], which counts the number of times we got to the irq
handler.

The main code waits until it detects mem[0] being equal to mem[1], then
exits.

Since mem[1] is initialized to 7, the timer interrupt fires 7 times before
exiting.
